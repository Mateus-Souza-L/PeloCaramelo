...
module.exports = {
  // GET /pets  -> lista todos os pets do tutor logado
  ...
  async createPet(req, res) {
    try {
      ...
      if (!name || !name.trim()) {
        return res
          .status(400)
          .json({ error: "Nome do pet é obrigatório." });
      }
  ...
  // PUT /pets/:id  -> edita um pet do tutor
  ...
  // DELETE /pets/:id  -> remove um pet do tutor
