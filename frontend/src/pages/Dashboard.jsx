  ...
  return (
    <div className="bg-[#EBCBA9] min-h-[calc(100vh-120px)] p-6">
      ...
      <div className="max-w-[1400px] mx-auto mb-4 flex justify-end">
        <Link
          to={`/avaliacoes?mode=${activeRole}`}
          className="px-4 py-2 rounded-2xl bg-[#FFD700]/90 hover:bg-[#FFD700] text-[#5A3AA22] font-semibold shadow text-sm"
        >
          Ver minhas avaliações
        </Link>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto bg-white rounded-2xl shadow p-6 border-l-4 border-[#FFD700]/80">
        {tab === "disponibilidade" && (
          <section>
            {/* ... todo o seu bloco de disponibilidade exatamente como está ... */}
          </section>
        )}

        {tab === "reservas" && (
          <section>
            {/* ... todo o seu bloco de reservas exatamente como está ... */}
          </section>
        )}
